  ...
  return (
    <div className="min-h-screen bg-[#f3e8dc]">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 z-10 text-center md:text-left">
            <h1
              ref={heroHeadingRef}
              className="font-display text-5xl sm:text-6xl md:text-7xl font-bold text-[#e0b10f] mb-4 md:mb-6 leading-tight"
            >
              {/* Removed whitespace-nowrap for better mobile word wrapping */}
              Welcome to Vakruta
            </h1>
            <p
              ref={heroParagraphRef}
              className="font-cinzel text-base md:text-xl text-[#15122e] mb-8 leading-relaxed max-w-xl mx-auto md:mx-0 opacity-0 transform -translate-x-12"
            >
              Discover the magnificence of Indian heritage through a celebration
              of tradition, innovation, and timeless elegance inspired by the
              grandeur of the Mughal Empire.
            ...
            <div className="flex justify-center md:justify-start gap-4">
              <button className="bg-[#15122e] hover:bg-[#e0b10f] hover:text-black text-white font-cinzel font-semibold px-6 py-3 md:px-8 md:py-3 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 text-sm md:text-base">
                Explore More
              </button>
              <button className="border-2 border-[#15122e] hover:border-none hover:text-black text-[#388697] hover:bg-[#e0b10f] hover:text-white font-cinzel font-semibold px-6 py-3 md:px-8 md:py-3 rounded-lg transition-all duration-300 hover:scale-105 text-sm md:text-base">
                Learn More
              </button>
            </div>
          </div>
          ...
          <div
            ref={heroImageRef}
            className="flex-1 relative w-full md:w-auto opacity-0 transform scale-75 rotate-12 mt-10 md:mt-0"
          >
            <div className="relative w-full h-80 sm:h-96 md:h-full flex items-center justify-center">
              {/* Decorative Blur Effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-blue-400/20 to-amber-400/20 rounded-3xl blur-3xl animate-pulse"></div>
              <div className="relative bg-white rounded-xl p-6 sm:p-8 border-2 border-blue-900/10 hover:shadow-3xl transition-shadow duration-500 max-w-xs sm:max-w-sm mx-auto">
                <img
                  src="https://cdn.builder.io/api/v1/image/assets%2F7c19d5750a434083a19dfc82c5f593f4%2F981caa52e21948b987df073157a54df3?format=webp&width=800"
                  alt="Vakruta Pattern"
        ...
        {/* Enhanced Decorative Elements (Positioning adjusted for mobile) */}
        <div className="absolute top-5 right-5 w-20 h-20 md:w-32 md:h-32 border-2 border-[#f5c422]/20 rounded-full opacity-40 animate-spin-slow"></div>
        <div className="absolute bottom-5 left-5 w-16 h-16 md:w-24 md:h-24 border border-[#8EC4D9]/20 rounded-lg opacity-20 transform rotate-45 animate-float"></div>
      </section>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2
              ref={aboutHeadingRef}
              className="font-display text-4xl sm:text-5xl md:text-6xl font-bold text-[#e0b10f] mb-4 opacity-0 transform scale-75"
            >
              About Vakruta
            </h2>
            <div className="w-full h-0.5 bg-gradient-to-r from-transparent via-[#f5c422] to-transparent max-w-md mx-auto"></div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div
              ref={aboutImageRef}
              className="bg-[#faf7f4] rounded-xl p-6 sm:p-8 border border-[#e8dcc8] opacity-0 transform -translate-x-12 rotate-3 hover:rotate-0 transition-transform duration-500 order-2 md:order-1"
            >
              <img
                src="https://cdn.builder.io/api/v1/image/assets%2F7c19d5750a434083a19dfc82c5f593f4%2F14012f80d4794515a0272d68adccc272?format=webp&width=500"
                alt="Indian Architecture"
            ...
            <div
              ref={aboutTextRef}
              className="space-y-6 opacity-0 transform translate-x-12 order-1 md:order-2"
            >
              <p className="font-cinzel text-base md:text-lg text-[#15122e] leading-relaxed">
                Vakruta stands as a testament to the rich cultural heritage of
                India, drawing inspiration from the magnificent Mughal Empire.
                Our mission is to celebrate the artistic excellence,
                architectural grandeur, and timeless traditions that have shaped
              ...
              {/* Stats Grid - Already responsive with grid-cols-3 */}
              <div className="grid grid-cols-3 gap-4 mt-8">
                <div className="bg-[#e8f3f7] rounded-lg p-3 sm:p-4 text-center border-l-4 border-[#388697] hover:scale-110 transition-transform duration-300">
                  <p className="font-display text-xl sm:text-2xl font-bold text-[#15122e]">
                    1000+
                  </p>
                  <p className="font-cinzel text-xs sm:text-sm text-[#388697]">
                    Members
                  </p>
                </div>
                <div className="bg-[#e8f3f7] rounded-lg p-3 sm:p-4 text-center border-l-4 border-[#388697] hover:scale-110 transition-transform duration-300">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl sm:text-5xl md:text-6xl font-bold text-[#e0b10f] mb-4">
              Our Legacy
            </h2>
            <div className="w-full h-0.5 bg-gradient-to-r from-transparent via-[#f5c422] to-transparent mx-auto mb-4 max-w-md"></div>
            <p className="font-cinzel text-lg md:text-xl text-[#15122e]">
              Celebrating Years of Excellence and Growth
            </p>
          </div>

          {/* Cards Section - Made max-w wider for better use of space on tablet/desktop */}
          <div
    ref={statsCardsRef}
    className="grid sm:grid-cols-2 lg:grid-cols-2 gap-8 max-w-6xl mx-auto"
>
    {[
      {
        year: "2025",
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-br from-[#388697]/5 to-[#f5c422]/5 rounded-2xl group-hover:from-[#388697]/20 group-hover:to-[#f5c422]/20 transition-all duration-500"></div>
        <div className="relative bg-[#faf7f4] rounded-2xl border border-[#e8dcc8] transition-all duration-500 group-hover:-translate-y-2 p-6 sm:p-8">
          <img
            src={stat.image}
            alt={stat.label}
          ...
          <div className="mt-6 text-center">
            <p className="font-cinzel text-xs sm:text-sm text-[#388697] uppercase tracking-wider">
              {stat.year} - {stat.label}
            </p>
            <p className="font-display text-3xl font-bold text-[#f5c422] mt-3">
              {stat.value}
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center mb-16">
            <h2
              ref={brochureHeadingRef}
              className="font-display text-4xl sm:text-5xl md:text-6xl font-bold text-[#e0b10f] mb-4 opacity-0 transform translate-y-12"
            >
              Discover Our Brochure
            </h2>
            <div className="w-full h-0.5 bg-gradient-to-r from-transparent via-[#f5c422] to-transparent mx-auto mb-6 max-w-md"></div>
            <p className="font-cinzel text-base md:text-lg text-[#15122e] max-w-2xl">
              Explore the complete story of Vakruta through our comprehensive
              brochure, featuring detailed information about our heritage,
              achievements, and vision.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div
              ref={brochureLeftRef}
              className="flex justify-center opacity-0 transform -translate-x-20 scale-75 order-2 md:order-1"
            >
              <div className="relative group max-w-sm">
                <div className="absolute inset-0 bg-gradient-to-br from-[#8EC4D9]/15 to-[#f5c422]/15 rounded-xl blur-2xl transition-all duration-500"></div>
                <div className="relative bg-[#faf7f4] rounded-xl overflow-hidden  transition-all duration-500">
                  {/* Aspect ratio kept square for visual design */}
                  <div className="relative w-full aspect- overflow-fit">
                    <img
                      src="https://cdn.builder.io/api/v1/image/assets%2F7c19d5750a434083a19dfc82c5f593f4%2Fa3b9abeeff424a8d82fadf2d789e4d7a?format=webp&width=600"
                      alt="Brochure Pattern"
                      className="w-full h-full object-cover mx-auto transition-all duration-700 group-hover:scale-110 group-hover:rotate-3"
            ...
            <div
              ref={brochureRightRef}
              className="space-y-6 opacity-0 transform translate-x-20 scale-75 order-1 md:order-2"
            >
              <div className="bg-[#e8f3f7] rounded-lg p-6 sm:p-8  transition-shadow duration-300">
                <h3 className="font-display text-2xl font-bold text-[#f5c422] mb-4">
                  What's Inside
                </h3>
                <ul className="space-y-4 font-cinzel text-base text-[#15122e]">
                  {[
                    "Complete History and Heritage of Vakruta",
                    "Detailed Architectural and Artistic Inspirations",
                    "Member Benefits and Opportunities",
              ...
              <button className="w-full bg-gradient-to-r from-[#388697] to-[#2a6a7e]  text-white font-display text-lg font-bold py-4 px-8 rounded-xl shadow-lg transition-all duration-300 transform hover:scale-105">
                Download Brochure
              </button>

              <p className="text-center font-cinzel text-xs sm:text-sm text-[#388697]">
                PDF format • 5.2 MB • Available in English & Hindi
              </p>
            </div>
          </div>
      ...
      >
        ...
        {/* Animated decorative elements (Sizes scaled for mobile) */}
        <div className="absolute top-0 left-0 w-64 h-64 md:w-96 md:h-96 bg-gradient-to-br from-[#8EC4D9]/30 to-transparent rounded-full blur-3xl -ml-32 -mt-32 md:-ml-48 md:-mt-48 animate-pulse"></div>
        <div
          className="absolute bottom-0 right-0 w-64 h-64 md:w-96 md:h-96 bg-gradient-to-tl from-[#f5c422]/20 to-transparent rounded-full blur-3xl -mr-32 -mb-32 md:-mr-48 md:-mb-48 animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-display text-4xl sm:text-5xl md:text-6xl font-bold text-[#e0b10f] mb-4 leading-tight">
            Join the Vakruta Movement
          </h2>
          <div className="w-24 h-1 bg-gradient-to-r from-transparent via-[#f5c422] to-transparent mx-auto mb-6"></div>
          <p className="font-cinzel text-base md:text-xl text-[#15122e] max-w-3xl mx-auto mb-10 md:mb-12 leading-relaxed">
            Be part of a growing community dedicated to preserving and
            celebrating the magnificent heritage of Indian civilization.
            Together, we honor the legacy of Mughal artistry and timeless
            cultural traditions.
          </p>
          <button className="bg-gradient-to-r from-[#f5c422] to-[#d4a913] text-[#15122e] font-display text-base md:text-2xl px-8 py-3 md:px-12 md:py-4 rounded-lg transition-all duration-300 transform hover:scale-105">
            Get Involved Today
          </button>
        </div>
      </section>
      ...
      <style>{`
        ...
        @font-face {
          font-family: 'Display';
          /* Replace with actual font loading logic for production */
          src: local('Georgia'), local('serif'); 
        }

        .font-cinzel {
          /* Replace with actual font loading logic for production (e.g., from Google Fonts) */
          font-family: 'Cinzel', Georgia, serif;
        }
      `}</style>
    </div>
